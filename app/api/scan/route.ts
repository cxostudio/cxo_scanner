...
9. Focus on proximity, language, and visibility requirements
          ...
          const screenshotToUse =
            (isVideoTestimonialRule && reviewsSectionScreenshotDataUrl) || (isCustomerPhotoRule && reviewsSectionScreenshotDataUrl)
              ...
              : screenshotDataUrl
          if (screenshotToUse && (isCustomerPhotoRule || isVideoTestimonialRule || isProductTabsRule || isTrustBadgesRule || isBenefitsNearTitleRule || isCTAProminenceRule || isFreeShippingThresholdRule || isVariantRule)) {
